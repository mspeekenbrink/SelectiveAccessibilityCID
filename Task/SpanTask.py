...
class Task:
    ...
    def __init__(self,win,filename,tasknr):
        ...
        self.Stimulus = visual.TextStim(self.win,text="",pos=(.0,.0),height=.15,alignVert='center',wrapWidth=1.5,fontFiles=[fontFile],font='LiberationMono')
        self.Response = visual.TextStim(self.win,text="___",pos=(.0,.0),height=.15,alignVert='center',wrapWidth=1.5,fontFiles=[fontFile],font='LiberationMono')
